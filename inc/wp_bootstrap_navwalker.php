...
class wp_bootstrap_navwalker extends Walker_Nav_Menu {
    ...
    public static function fallback( $args ) {
        //if ( current_user_can( 'manage_options' ) ) {
            ...
            $navigation = wp_get_nav_menu_object( $menu_name );
            $items = wp_get_nav_menu_items($navigation->term_id);
            // printme($items);exit();
            $fb_output .= '>';
            ...
            // $fb_output .= '<li class="nav-item"><a href="'.get_permalink( wc_get_page_id( 'cart' ) ).'" class="nav-link"><i class="fa fa fa-cart-plus"></i> CART</a></li>';
