...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'header_banner_title_setting', array(
        'default' => __( 'Purchase Stunning Mockups & Video Ads', 'wp-bootstrap-starter' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_title_setting', array(
     ...
     $wp_customize->add_setting(
        'header_banner_title_setting_color',
        array(
            'default'     => '#fff',
            'sanitize_callback' => 'sanitize_hex_color',
        )
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_banner_title_setting_color',
            array(
                'label'      => __( 'Banner Title Text Color', 'wp-bootstrap-starter' ),
                'section'    => 'header_image',
                'settings'   => 'header_banner_title_setting_color',
            ) )
    );

    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'Professionally created, delivered in hours.','wp-bootstrap-starter' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    ...
    $wp_customize->add_setting(
        'header_banner_tagline_setting_color',
        array(
            'default'     => '#fff',
            'sanitize_callback' => 'sanitize_hex_color',
        )
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_banner_tagline_setting_color',
            array(
                'label'      => __( 'Banner Tagline Text Color', 'wp-bootstrap-starter' ),
                'section'    => 'header_image',
                'settings'   => 'header_banner_tagline_setting_color',
            ) )
    );
    ...
    //ADD LOGO HEIGHT IN PIXELS IN SECTION c
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_logo_height', array(
        'label' => __( 'Logo Height in Pixels', 'wp-bootstrap-starter' ),
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_logo_width', array(
        'label' => __( 'Logo Width in Pixels', 'wp-bootstrap-starter' ),
        'section'    => 'title_tagline',
